...
/*
        echo $address = "0x".$ethaddress->address;
...
*/
   	...
   	function createUserEthTransaction($uid,$eth_amount,$gasprice="35000000000")
    {
        ...
        $params = array(
            ...
            "amount"        => $eth_amount,
            "gasprice"      => $gasprice,
            "url"           => "https://mainnet.infura.io/v3/bf406044d91b436da45cf9140a0f16de"
        );
        curl_setopt($ch, CURLOPT_URL, "http://206.189.232.6:8545");
        curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
        curl_setopt($ch, CURLOPT_POST, 1);
