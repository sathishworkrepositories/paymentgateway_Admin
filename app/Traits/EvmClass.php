...
trait EvmClass
{
    public function evmcreate() {
        $tokenAPI = "78021f6968654b03bc4e536de1be14d4";
        $ch = curl_init();
    ...
    public function getEVMDetails($network){
        if($network == 'ETH'){
            $data['apiKey'] =  "Y6X8CEV5RXUDBMM9D61J99BCGQNAG526FU";
            ...
            $data['apiKey'] =  "DT9HNYVQHVP1Z39C5HTRM788EKRH1Z6WRE";
            ...
            $data['apiKey'] =  "TT8JZF7IDSIMBGRQ878GUZCB4E5CS2U8ZQ";
