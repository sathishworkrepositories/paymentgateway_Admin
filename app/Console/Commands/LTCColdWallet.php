...
class LTCColdWallet extends Command
{
    use LtcClass;
    /**
     ...
     * @var string
     */
    protected $signature = 'coldwallet:ltc';
     ...
     * @var string
     */
    protected $description = 'Move LTC balance to admin cold wallet';
    ...
    {
        $trans = CryptoTransactions::where(['nirvaki_nilai' => 0,'currency' => 'LTC'])->get();
        if(count($trans) > 0){
        ...
        $this->info('Balance moved to admin LTC address');
    }
}
