            ...
            <div class="login__block__body">
                ...
                <form class="form-horizontal" role="form" method="POST" action="{{ url('login') }}" autocomplete="nope">
                    ...
                    <div class="form-group">
                        ...
                        <span class="input-group-text" id="passtexticon" onclick="getPasswordResponse()"><i class="fa fa-eye-slash" aria-hidden="true"></i></span>
                        </div>
                    ...
                    <button type="submit" name="secure-adminlogin" class="btn btn--icon login__block__btn">Login</button>
                </form>
            </div>
        </div>
    </div>
