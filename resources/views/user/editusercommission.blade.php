...
<section class="content">
	<header class="content__title">
		<h1>View Commission Details</h1>
	</header>
	<div class="row">
		<div class="col-md-12">
			<div class="card">
				<div class="card-body">
					<a href="{{ url('/admin/usercommissionsetting/'.Crypt::encrypt($userdetails->id)) }}"><i class="zmdi zmdi-arrow-left"></i> Back to User Commission</a>
					<br /><br />
					@if(session('status'))
					...
					<form method="post" action="{{ url('admin/usercommissionupdate') }}" autocomplete="off">
						{{ csrf_field() }}
						<input type="hidden" value="{{ $commission->id }}" name="id">
						<input type="hidden" value="{{ $userdetails->id }}" name="uid">
						<div class="row">
							<div class="col-md-3">
